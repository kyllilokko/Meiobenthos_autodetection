...
model_save_path = "8groups_models_trained"
log_path = os.path.join(model_save_path, f"8groups_training_log_{current_time}.txt")
...
train_dataset = get_coco_dataset(
    ...
    ann_file=os.path.join(dataset_path, "train/annotations/meiobenthos_train_8groups_augmented_coco.json")
)
...
num_classes = 9 # Background + nematode + rotifer + Testacea + ciliate + turbellarians + annelida + arthropoda + tardigrada
