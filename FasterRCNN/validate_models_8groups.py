...
val_dataset = CocoDetection(
    root="dataset/val",
    annFile="dataset/val/annotations/meiobenthos_val_8groups_coco.json",
...
# ➡️ Evaluate model with per-class metrics precision/recall/F1 etc
...
models_dir = "8groups_models_trained"
...
if not os.path.exists(csv_filename):
    ...
    for model_file in model_files:
        ...
        annFile="/content/drive/My Drive/meiobenthos/dataset/val/annotations/meiobenthos_val_8groups_coco.json"
